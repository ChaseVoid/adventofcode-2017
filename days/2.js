  ...
  'partA = ' +
    ...
    3021	3407	218	1043	449	214	1594	3244	3097	286	114	223	1214	3102	257	3345`
      ...
      .reduce((accumulator, currentValue, currentIndex, array) => {
        const [min, max] = [
          Math.min(...currentValue),
          Math.max(...currentValue)
        ]
    ...
    3021	3407	218	1043	449	214	1594	3244	3097	286	114	223	1214	3102	257	3345`
      ...
      .map(row =>
        row
          ...
          .split('\t')
          .map(Number)
          .sort((a, b) => b - a) // sort in decending order
          .reduce((accumulator, currentValue, currentIndex, array) => {
            const size = array.length
            const step = 1
            const nextIndex = (currentIndex + step) % size

            array.forEach((element, index) => {
              if (index > currentIndex && currentValue % element === 0)
                accumulator = currentValue / element
            })
